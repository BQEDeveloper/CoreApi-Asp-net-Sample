using BQE.Core.OAuth2.SampleApp.DotNet.Models;
...
/******************************************************
 * CORE sample app for Oauth2 without BQE CORE .Net SDK
 * RFC docs- https://tools.ietf.org/html/rfc6749
 * ****************************************************/

namespace BQE.Core.OAuth2.SampleApp.DotNet
{
    public partial class CoreOAuth2Helper : System.Web.UI.Page
    {
        ...
        protected void ConnectCore_Click(object sender, EventArgs e)
        {
            if (Session["accessToken"] == null)
            {
        ...
        protected void OpenId_Click(object sender, EventArgs e)
        {
            if (Session["accessToken"] == null)
            {
        ...
        protected void SIWC_Click(object sender, EventArgs e)
        {
            if (Session["accessToken"] == null)
            {
                //call this once a day or at application_start in your code.
        ...
        protected void CoreAPICall_Click(object sender, EventArgs e)
        {
        ...
        protected void CoreAPIPOST_Click(object sender, EventArgs e)
        {
            //if (Session["companyId"] != null)  //TODO
            {
                if (Session["accessToken"] != null)// && Session["refreshToken"] != null)
        ...
        protected void UserInfoAPICall_Click(object sender, EventArgs e)
        {
            //if (Session["companyId"] != null)  //TODO
            {
                if (Session["accessToken"] != null)
        ...
        #region OAuth2 calls
        private void authnticateMe(string callMadeBy)
        {
        ...
        private void exchangeCode(string code, string redirectURI, string companyId)
        {
